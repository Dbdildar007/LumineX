  ...
  return (
    <div onClick={()=>!lpOn&&playVideo(video)} onMouseEnter={onEnter} onMouseLeave={onLeave}
      ...
      <div style={{ position:"relative", aspectRatio:"16/9", overflow:"hidden", background:"#111" }}>
        ...
        {/* VIP blur */}
        {video.is_vip&&!active&&(
          <div style={{ position:"absolute",inset:0,zIndex:2,background:"rgba(0,0,0,.45)",backdropFilter:"blur(3px)",display:"flex",alignItems:"center",justifyContent:"center" }}>
            <div style={{ background:"linear-gradient(135deg,#fbbf2433,#f9731633)",border:"1px solid #fbbf2466",borderRadius:12,padding:"8px 18px",textAlign:"center" }}>
              <div style={{ fontSize:20,marginBottom:2 }}>👑</div>
              <div style={{ fontSize:10,fontWeight:800,color:"#fbbf24",letterSpacing:1 }}>VIP ONLY</div>
            </div>
          </div>
        )}
